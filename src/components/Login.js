...
import { getUserDataFromLocalStorage } from '../Utils/xmlUtils'; // Update the import path if necessary
...
const Login = () => {
  ...
  return (
    <Box style={{ backgroundImage: 'url(https://img.freepik.com/premium-psd/creative-social-media-internet-mockup-with-laptop-keyboard_23-2147940598.jpg?semt=ais_hybrid)', backgroundSize: 'cover', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
