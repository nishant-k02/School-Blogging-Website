...
// API keys setup
const IPAPI_KEY = process.env.IPAPI_KEY || 'your_ipapi_key_here';
const OPENWEATHERMAP_API_KEY = process.env.OPENWEATHERMAP_API_KEY || 'your_openweathermap_key_here';
// const GOOGLE_API_KEY = process.env.GOOGLE_API_KEY || '';
const SERPAPI_KEY = process.env.SERPAPI_KEY || 'your_serpapi_key_here';
const TICKETMASTER_API_KEY = process.env.TICKETMASTER_API_KEY || 'your_ticketmaster_key_here';
